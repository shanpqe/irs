 ...
 <div class="main-panel ">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
              <!-- <div class="d-flex justify-content-between flex-wrap"> -->
                ...
                <div style="height:60px;" class="p-3 mb-2 bg-primary text-white">
                        ...
                        <button style="background-color: #e7e7e7; color: black;position:relative;left:850px;top:-35px; " class="btn btn-default" onclick="window.location.href='#'"><b>Back</b></button>   
            ...
            <div class="col-md-50 stretch-card ">
                ...
                <div class="card-body ">
                    <div>
                            ...
                            <ul class="nav nav-pills" id="myTabMD" role="tablist">
                                  <li class="nav-item">
                                  <a class="nav-link" data-toggle="pill" href="#personaldetails-md" role="tab" aria-controls="personaldetails-md"
             ...
             <!-- 1         -->
                           <div class="tab-pane" id="personaldetails-md" role="tabpanel" aria-labelledby="home-tab-md">
              ...
              <!-- 2 -->
                          <div class="tab-pane" id="educationaldetails-md">
              ...
              <!-- 3 -->
                            <div class="tab-pane" id="professionaldetails-md" role="tabpanel" aria-labelledby="home-tab-md">
              ...
              <!-- 4       -->
                        <div class="tab-pane" id="additionalskills-md" role="tabpanel" aria-labelledby="home-tab-md">
              ...
              <!-- 5     -->
                        <div class="tab-pane" id="others-md" role="tabpanel" aria-labelledby="home-tab-md">
                                      <br>
                          <div style="padding-left:10px;padding-right:10px;width:950px;height:600px;border:1px solid #000;position:relative;top:-45px;">
                          ...
                          <b> Current Sallary <font color="red">*</font>&ensp;&ensp;</b><input type="text" name="currentsallary" >
                            ...
                            <input style=" position:absolute; bottom:10px; right:10px;" type="submit" class="btn btn-primary" value="Save">   
                            </div>
                            <Button class="btn btn-primary" ID="btnPrevious"
                                    Width="50px" Height="50px" >Back
                                  <Button class="btn btn-primary" ID="btnNext"  Width="50px" Height="50px"
