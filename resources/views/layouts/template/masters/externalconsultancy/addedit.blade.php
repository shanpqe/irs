              ...
              <div class="card" style="width: 63rem;">
                <div class="card-body">
                  ...
                  <form action="#">
                        ...
                        <fieldset>
                        <b> Company Naame:<font color="red">*</font>
                        </b>
                        <input type="text" name="fname">
                       </fieldset>
                       <fieldset style="position:relative;top:52px;">
                       <b> Country :<font color="Red">*</font> </b>
                        <select name="country">
                            <option value="Select Country " disabled>Select Normalized Job Title(s)</option>
                        ...
                        <input type="text" name="description" style="height:70px;position:relative;top:26px;">
                       </fieldset>
                        <fieldset class="inputright" style="top:-40px;">
