 ...
 <div class="main-panel">
        ...
        <thead>
              <tr class="bg-primary text-white">
                <th>Normalized Job Title Name</th>
                <th>Description</th>
                <th>Action</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{asset('templatedata/images/edit.svg')}}">&emsp;&emsp;<img src="{{asset('templatedata/images/del.svg')}}"></td>
