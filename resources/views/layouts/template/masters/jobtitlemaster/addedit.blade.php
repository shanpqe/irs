              ...
              <div class="card" style="width: 63rem;">
                <div class="card-body">
                  ...
                  <form action="#">
                        ...
                        <fieldset>
                        <b> Name:<font color="red">*</font>
                        </b>
                        <input type="text" name="fname">
                       </fieldset>
                       <fieldset style="position:relative;top:64px;">
                       <input type="radio" name="unit" value="unit" checked> Unit
                      <input type="radio" name="department" value="department"> Department
                        </fieldset>
                        
                        <fieldset style="position:relative;top:84px;">
                        <b> Unit :<font color="Red">*</font> </b>
                        <select  name="unitlist">
                            <option value="Select Unit(s)">Select Unit(s)</option>
                            <option value="Compliance">Compliance</option>
                            <option value="Validation">Validation</option>
                            <option value="Qualification/ Quality Engineering">Qualification/ Quality Engineering</option>
                        ...
                        <fieldset class="inputright" style="top:-39px;">
                        <b> Normalized Job Title: </b>
                        <select name="normalisedjobtitle">
                            <option value="Select Normalized Job Title(s)" disabled>Select Normalized Job Title(s)</option>
                            <option value="Proect Manager">Proect Manager</option>
                            <option value="CSV Manager">CSV Manager</option>
                        </select>
                        </fieldset>
                        <br>
                        <fieldset>
                            <button onclick="window.location.href='/#'" type="button" class="btn btn-primary float-left">Save</button>
