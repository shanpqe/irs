...
<div class="container-scroller">
 ...
 <div class="main-panel">
                ...
                <div class="card-body">
                  ...
                  <div style="padding-left:10px;padding-right:10px;">
                        <div style="height:200px;width:30%;position:relative;">
                            <div>
                            <b>Role Name:</b> Admin <br> <br><br>
                            <b>Privilege For:</b> Admin  <br><br>
                        ...
                        <div style="height:200px;width:39%;position:relative;top:-200px;left:55%;">
                               <div>
                               
                                <b>Description:</b> Able to access All masters, User & Role management and Candidate Field Management <br> <br><br>
                                <b> </b> <br><br><br>
                                <div style="width:350px;">
                                    ...
                                    <div style="width:50%;">
                                        <input type="checkbox" name="uploadresume" disabled value="Upload Resume"> Upload Resume<br>
                                        <br>
                                        <input type="checkbox" name="exporttocsv" disabled value="Export to Excel/CSV"> Export to Excel/CSV<br>
                                        <br>
                                        <input type="checkbox" name="editcandidatedetails" disabled value="Edit Candidate Details">Edit Candidate Details<br>
                                        <br>
                                        <input type="checkbox" name="editcandidatedetails" disabled value="View Candidate Details">View Candidate Details<br>
                                        <br>
                                    </div>
                                     <div style="width:50%;position:relative;left:50%;top:-175px;" >
                                        <input type="checkbox" name="globallysearch" disabled value="Globally Search"> Globally Search<br>
                                        <br>
                                        <input type="checkbox" name="delete" disabled  value="Delete">Delete<br>
                                        <br>
                                        <input type="checkbox" name="editrecruitmentdata" disabled value="Edit Recruitment Data"> Edit Recruitment Data<br>
                                        <br>
                                        <input type="checkbox" name="viewrecruitmentdata" disabled  value="View Recruitment Data"> View Recruitment Data<br>
                                        <br>
                                    </div>
                                    </div>
                                </div>
  ...
  JS For Select Item Change Ends Here
</body>
