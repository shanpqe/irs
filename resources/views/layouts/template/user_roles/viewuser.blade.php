                ...
                <div class="card-body">
                  ...
                  <div style="padding-left:10px;padding-right:10px;">
                        <div style="height:200px;width:30%;position:relative;">
                            <div>
                            <b>First Name:</b> Andrew <br> <br><br>
                            <b>Email:</b> andrew.john@gmail.com<br><br><br>
                            <b>Role:</b> Admin <br><br>
                            <input type="checkbox" id="myCheck" checked disabled><b>&ensp;Active?</b>
                            </div>
                            <br>
                            <br>
                        ...
                        <div style="height:200px;width:30%;position:relative;top:-400px;left:66%;">
                               <div>
                                ...
                                <b>Last  Name:</b> Andrew <br> <br><br>
                                <b>Email:</b> +39 088 572 900<br><br><br>
                                <b>Subsidiary(ies):</b> PQE India, PQE Italy <br><br><br>
