            ...
            <div class="col-md-50 stretch-card">
              <div class="card" style="width: 63rem;">
                ...
                <h4>Company Logo</h4>
                  <form action="#">
                           <fieldset>
                            Upload Logo:<font color="Red">*</font>
                                <div class="custom-file" style="position:relative;width:24%;">
                                    <input  type="file" accept="image/*" class="custom-file-input" id="inputlogo">
                                    <label class="custom-file-label" for="inputlogo"></label>
                                </div>
                                <font color="grey">
                                    <small>
                                    <b>Supported Formats:</b>  .png, .jpeg, .jpg
                                    </small>
                                   <p style="position:relative;left:418px;top:-18px;">
                                    <small>
                                    <b>Size: </b>Up to 1 MB
                                    </small>
                                    </p>
                            ...
                            <fieldset>
                                <b>Preview:</b><br><br>
                                <img src="https://d1icd6shlvmxi6.cloudfront.net/gsc/UAV723/0b/54/03/0b540347611146f6b05f5dbb26a803a2/images/settings/u3740.png?token=30b9eb1443c9b17b97f3e85d4dd074682e6cae6a14bb8b40fbc15c001f07ae37" alt="Image Preview" height="120" width="120">
                            </fieldset>
                            <br>
                            <fieldset>
                            <center>
                                 <input type="submit" class="btn btn-primary" value="Save"></button>&ensp;&ensp;&ensp;
                              <button style="background-color: #e7e7e7; color: black;" type="button" class="btn btn-default">Cancel</button>
                            </center>
                            </fieldset>
