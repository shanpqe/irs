            ...
            <div class="col-md-50 stretch-card">
              <div class="card" style="width: 70rem;">
                ...
                <form action="#">
                  ...
                  <!-- <button style="position:relative;top:-25px;left:400px;" onclick="window.location.href='/page2'">Home</button> -->
               </div>
              </div>
            </div>
          </div>
